...
(deftest doopt-test
  (let [mmap-states (doopt :smc q [2] 100 :bo-verbose true :opt-type :mmap)
        ml2-states (doopt :smc q [2] 100 :bo-verbose true :opt-type :ml2)]
...
;;     (observe (normal (+ a b) theta) y)
;;     [a b]))
;; (def mmap-states (doopt :smc q4 [2] 100 :bo-verbose true :opt-type :mmap))
